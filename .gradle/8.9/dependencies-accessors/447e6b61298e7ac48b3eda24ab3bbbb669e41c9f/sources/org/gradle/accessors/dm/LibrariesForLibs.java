...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final SingleLibraryAccessors laccForSingleLibraryAccessors = new SingleLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>single</b>
     */
    public SingleLibraryAccessors getSingle() {
        return laccForSingleLibraryAccessors;
    }
    ...
    public static class SingleLibraryAccessors extends SubDependencyFactory {
        private final SingleRowLibraryAccessors laccForSingleRowLibraryAccessors = new SingleRowLibraryAccessors(owner);

        public SingleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>single.row</b>
         */
        public SingleRowLibraryAccessors getRow() {
            return laccForSingleRowLibraryAccessors;
        }

    }

    public static class SingleRowLibraryAccessors extends SubDependencyFactory {

        public SingleRowLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>calendar</b> with <b>com.michalsvec:single-row-calendar</b> coordinates and
         * with version reference <b>single.row.calendar</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCalendar() {
            return create("single.row.calendar");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final SingleVersionAccessors vaccForSingleVersionAccessors = new SingleVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.single</b>
         */
        public SingleVersionAccessors getSingle() {
            return vaccForSingleVersionAccessors;
        }

    }

    public static class SingleVersionAccessors extends VersionFactory  {

        private final SingleRowVersionAccessors vaccForSingleRowVersionAccessors = new SingleRowVersionAccessors(providers, config);
        public SingleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.single.row</b>
         */
        public SingleRowVersionAccessors getRow() {
            return vaccForSingleRowVersionAccessors;
        }

    }

    public static class SingleRowVersionAccessors extends VersionFactory  {

        public SingleRowVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>single.row.calendar</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCalendar() { return getVersion("single.row.calendar"); }
